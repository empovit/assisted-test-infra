...
class AgentClusterInstall(BaseCustomResource):
    ...
    def create(
        ...
        **kwargs,
        ...
        metadata.update({"annotations": {"agent-install.openshift.io/install-config-overrides": "{\"networking\": {\"networkType\": \"OVNKubernetes\", \"machineNetwork\": [{\"cidr\": \"192.168.126.0/24\"}, {\"cidr\": \"1001:db8::/120\"}], \"clusterNetwork\": [{\"cidr\": \"10.128.0.0/14\", \"hostPrefix\": 23}, {\"cidr\": \"fd01::/48\", \"hostPrefix\": 64}], \"serviceNetwork\": [\"172.30.0.0/16\", \"fd02::/112\"]}}"}})
        body = {
